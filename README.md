...
4. the installer is trying to install readline, however, this is not intended for windows, need to find where this is mentioned in scripts, and update appropriately. Likewise, the readline was intended to notify upon updates to the yaml, however, we need to do this in windows python. we must think about this, and come up with a solution.
