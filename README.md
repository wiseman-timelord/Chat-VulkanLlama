...
### FUTURE PLANS:
1) scripts must be updated to GGUF based models, and remove support for GGML, this is the second time, delete and download, all models, how long its been, 4 months, burr...
