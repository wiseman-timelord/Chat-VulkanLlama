...
* The models the program are advised to work with are currently under review, but one of the Llama 2 7b Chat 8Bit GGML models will probably do the task for the required chat model.
