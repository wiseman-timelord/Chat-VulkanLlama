...
1) 2 less scripts, python will now resize the windows correctly with os dependent code in the window scripts, utilizing additional package "xterm", before this was done through batch and only available to windows users..
