...
* Delayed due to Huggingface changing downloads to not work on my Downlord app, it just keeps retrying, have to rely upon unrelyable browser based downloads on mobile broadband, this somewhat sabotages my plans for testing other models, though I do already have have a few variants to test it on.
