...
* Prompts work better now, still tuning via, --output logs & gpt reformat prompt to test, hopefully get this done today.
...
* The models the program are advised to work with are currently under review, but I am testing on the Llama 2 7b Chat 8Bit GGML model, that one "https://huggingface.co/TheBloke/llama2_7b_chat_uncensored-GGML" will suffice.
