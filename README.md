...
* Large Language Models in the format of, Llama 2 GGUF, that could be between, 2GB and 40GB, or more if you should choose, and are typically sourced from website "www.huggingface.co", such as [this one](https://huggingface.co/TheBloke/Llama-2-7b-Chat-GGUF/resolve/main/llama-2-7b-chat.Q8_0.gguf), I notice grammatical errors on a 2 Bit, if working on code you want [smallest](https://huggingface.co/TheBloke/Llama-2-7b-Chat-GGUF) for faster loading.
