...
I noticed the program does not run with these much anticipated llama 2 uncensored models (this is why only the models below work). After completing work on ScriptClean, I will be doing this...
