...
3. Possibly there is a model with, map and image, generation.This would be solution for the map and ai graphics, need to research this. Map Generation could be text,  but it would make sense that when on the map, the user would be heading somewhere.
