...
* Delayed due to Huggingface changing downloads to not work on my Downlord app, it just keeps retrying, have to rely upon unrelyable browser based downloads on mobile broadband, this somewhat sabotages my plans for testing other Llama 2 based models, though do have a few variants to test it on already, for now we will go with them.
