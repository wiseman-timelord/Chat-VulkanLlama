...
* While Llama2Robot may be made by a timelord, this does not grant the, User and/or Developer, of Llama2Robot, the, approval from or rites of, the timelord. In short, Llama2Robot is a project for one to develop ones own AI software to do things that are of interest to relevantly the, User and/or Developer, however, relevantly the, User and/or Developer, are then responsible for their own modifications to the framework, that by itself is a roleplaying chatbot. Additionally, if one happens to earn a significant amount of finances through the use of their own developed versions of Llama2Robot, then consider organising some fitting amount of those finances back to the original Author Wiseman-Timelord for his hard work done.
