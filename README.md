...
* The models the program are advised to work with are currently under review, but I am testing on the Llama 2 7b Chat 8Bit GGML model, that one will suffice.
